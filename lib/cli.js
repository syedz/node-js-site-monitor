...
cli.responders.help = function() {
    var commands = {
        ...
        stats: 'Get statisitics on the udnerlying operating system and resource utilization',
        ...
        'more check info --{checkI}': 'Show details of a specified check',
...
cli.responders.moreUserInfo = function(str) {
    console.log('You asked for more user fnfo', str);
};
...
cli.processInput = function(str) {
    ...
    if (str) {
        // Codify the unique strings that identify the uniequ questions allowed to be asked
        var uniqueInputs = [
            'man',
            'help',
            'exit',
